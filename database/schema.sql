-- ============================================
-- PLATAFORMA DE RIFAS DIGITALES - SCHEMA COMPLETO v2.0
...
-- ============================================
-- 1. TABLA: users (Compradores - SIN REGISTRO)
-- ============================================
...
-- ============================================
-- 2. TABLA: admin_users (Creadores - REGISTRO OBLIGATORIO)
-- ============================================
...
-- ============================================
-- 5. TABLA: raffle_images (Galería de imágenes)
-- ============================================
...
-- ============================================
-- 14. TABLA: tapazos (El Tapazo - juego de la tapita)
-- ============================================
...
CREATE TABLE IF NOT EXISTS `tapazo_jugadores` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- ============================================
-- DATOS: LOTERÍAS COLOMBIANAS ACTUALIZADAS
-- ============================================
...
-- BANNERS DEL SISTEMA
-- ============================================
INSERT INTO `banners` (`title`, `subtitle`, `image_url`, `button_text`, `button_link`, `order_num`, `active`) VALUES
('Gana tu Gran Premio', 'Participa en las rifas más grandes de Colombia', 'https://images.unsplash.com/photo-1592921870789-04563d55041c?w=1600', 'Ver Rifas Activas', '/public/ganadores.php', 1, 1),
('Paga con Nequi', 'Pago instantáneo y seguro', 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1600', 'Participar', '/public/index.php', 2, 1);
