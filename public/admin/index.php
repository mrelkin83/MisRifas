...
<?php else: ?>
    ...
    // página) y lo precarga como sugerencia. Nunca guarda ni verifica: el
    // super_admin revisa y confirma con "Guardar resultado".
    ...
    window.openUserEdit = (type, id) => {
        ...
        // El rol solo aplica a organizadores; para compradores se oculta.
