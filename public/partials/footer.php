    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 py-16">
            ...
            <div class="lg:col-span-1">
                <a href="<?= $basePath ?>/public/index.php" class="flex items-center gap-2 mb-4">
                    ...
                    <span class="text-xl font-black text-amber-400"><?= plataforma_e() ?></span>
                </a>
            ...
            <div>
                ...
                <ul class="space-y-2.5">
                    ...
                    <li><a href="<?= $basePath ?>/public/que-es.php" class="text-slate-400 hover:text-white transition-colors text-sm">¿Qué es <?= plataforma_e() ?>?</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-sm text-slate-400">
                    ...
                    <li class="flex items-center gap-2">
                        <svg class="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 6-10 7L2 6"/></svg> <?= plataforma_e('email') ?>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="border-t border-slate-800/50 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p class="text-xs text-slate-500">
                &copy; <?= date('Y') ?> <?= plataforma_e() ?>. Todos los derechos reservados.
            </p>
